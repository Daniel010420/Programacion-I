Public Class formdescuentos
    ...
    Dim mensajeenmentana = "Registro de Descuento"
    Dim Nombretabladebusqueda = "Descuentos"
    Dim buscarpor1 = "TipoCliente"
    Dim buscarpor2 = "MargenDescuento"

    Dim idTabla = "IdDescuentos"
    Dim comandoinsertar = Nombretabladebusqueda + " (IdTipoClientes,MargenDescuento)" 'campos de la tabla en orden menos id
    Dim comandoactualizar = Nombretabladebusqueda

    Private Sub formdescuentos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        txtid.Visible = False
...
Private Sub btneliminar_Click(sender As Object, e As EventArgs) Handles btneliminar.Click
    If txtid.Text <> "" Then
            If (MessageBox.Show("Esta seguro de borrar a " + txtdescuento.Text, mensajeenmentana,
                           MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes) Then
                comandosql = Nombretabladebusqueda
                Dim msg = objConexion.mantenimientoDescuentos(New String() {txtid.Text}, "eliminar", comandosql, idTabla)
