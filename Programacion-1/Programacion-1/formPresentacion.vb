Public Class formPresentacion
    ...
    Dim mensajeenmentana = "Registro de Presentacion"
    Dim Nombretabladebusqueda = "Presentacion"
    Dim buscarpor1 = "Presentacion"
    Dim buscarpor2 = "Presentacion"
    Dim idTabla = "IdPresentacion"
    Dim comandoinsertar = Nombretabladebusqueda + " (Presentacion)" 'campos de la tabla en orden menos id
    ...
    Sub obtenerdatos()
        Try
            ...
            grid.DataSource = objConexion.obtenerDatos().Tables("Presentacion").DefaultView
    ...
    Private Sub btnnuevoyaceptar_Click(sender As Object, e As EventArgs) Handles btnnuevoyaceptar.Click
        ...
        ElseIf btnnuevoyaceptar.Text = "Aceptar" Then
            ...
            Dim msg = objConexion.mantenimientoPresentacion(New String() {
    ...
    Private Sub btneliminar_Click(sender As Object, e As EventArgs) Handles btneliminar.Click
        If txtid.Text <> "" Then
            If (MessageBox.Show("Esta seguro de borrar a " + txtnombre.Text, mensajeenmentana,
                ...
                Dim msg = objConexion.mantenimientoPresentacion(New String() {txtid.Text}, "eliminar", comandosql, idTabla)
