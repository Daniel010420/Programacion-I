Public Class formRegistroMedicamento
    ...
    Dim mensajeenmentana = "Registro de Medicamento"
    Dim Nombretabladebusqueda = "RegistroMedicamento"
    Dim buscarpor1 = "NombreMedicamento"
    Dim buscarpor2 = "Laboratorio"

    Dim idTabla = "IdRegistroMedicamento"
    Dim comandoinsertar = Nombretabladebusqueda + " (NombreMedicamento,IdPresentacion,IdLaboratorio)" 'campos de la tabla en orden menos id
    Dim comandoactualizar = Nombretabladebusqueda

    Private Sub formRegistroMedicamento_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        txtid.Visible = False
