Public Class TipoFactura
    ...
    Dim mensajeenmentana = "Registro Tipos Factura"
    Dim Nombretabladebusqueda = "Tipofactura"
    Dim buscarpor1 = "tipofactura"
    Dim buscarpor2 = "tipofactura"
    Dim idTabla = "Idtipofactura"
    Dim comandoinsertar = Nombretabladebusqueda + " (tipofactura)" 'campos de la tabla en orden menos id
    Dim comandoactualizar = Nombretabladebusqueda
    Private Sub TipoFactura_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        txtid.Visible = False
    ...
    Sub obtenerdatos()
        Try
            ...
            grid.DataSource = objConexion.obtenerDatos().Tables("Factura").DefaultView
    ...
    Private Sub btnnuevoyaceptar_Click(sender As Object, e As EventArgs) Handles btnnuevoyaceptar.Click
        ...
        ElseIf btnnuevoyaceptar.Text = "Aceptar" Then
            ...
            If txtnombre.Text <> "" Then
                Dim msg = objConexion.mantenimientotipofactura(New String() {
    ...
    Private Sub btneliminar_Click(sender As Object, e As EventArgs) Handles btneliminar.Click
        If txtid.Text <> "" Then
            If (MessageBox.Show("Esta seguro de borrar a " + txtnombre.Text, mensajeenmentana,
                ...
                Dim msg = objConexion.mantenimientotipofactura(New String() {txtid.Text}, "eliminar", comandosql, idTabla)
