Public Class formtipocliente 'Realiza la conexion a la base solo para este formulario
    ...
    Dim mensajeenmentana = "Registro de Tipos de Clientes"
    Dim Nombretabladebusqueda = "TipoCliente"
    Dim buscarpor1 = "TipoCliente"
    Dim buscarpor2 = "TipoCliente"
    Dim idTabla = "IdTipoCliente"
    Dim comandoinsertar = Nombretabladebusqueda + " (TipoCliente)" 'campos de la tabla en orden menos id
    ...
    Sub obtenerdatos()
        Try
            ...
            grid.DataSource = objConexion.obtenerDatos().Tables("TipoCliente").DefaultView
    ...
    Private Sub btnnuevoyaceptar_Click(sender As Object, e As EventArgs) Handles btnnuevoyaceptar.Click
        ...
        ElseIf btnnuevoyaceptar.Text = "Aceptar" Then
            ...
            Dim msg = objConexion.mantenimientoTiposCliente(New String() {
    ...
    Private Sub btneliminar_Click(sender As Object, e As EventArgs) Handles btneliminar.Click
        If txtid.Text <> "" Then
            If (MessageBox.Show("Esta seguro de borrar a " + txtnombre.Text, mensajeenmentana,
                ...
                Dim msg = objConexion.mantenimientoTiposCliente(New String() {txtid.Text}, "eliminar", comandosql, idTabla)
