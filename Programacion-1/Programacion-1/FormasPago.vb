Public Class FormasPago
    ...
    Dim mensajeenmentana = "Registro Formas Pago"
    Dim Nombretabladebusqueda = "Formapago"
    Dim buscarpor1 = "Formapago"
    Dim buscarpor2 = "Formapago"
    Dim idTabla = "Idformapago"
    Dim comandoinsertar = Nombretabladebusqueda + " (Formapago)" 'campos de la tabla en orden menos id
    Dim comandoactualizar = Nombretabladebusqueda
    Private Sub FormasPago_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        txtid.Visible = False
    ...
    Sub obtenerdatos()
        Try
            ...
            grid.DataSource = objConexion.obtenerDatos().Tables("formapago").DefaultView
    ...
    Private Sub btnnuevoyaceptar_Click(sender As Object, e As EventArgs) Handles btnnuevoyaceptar.Click
        ...
        ElseIf btnnuevoyaceptar.Text = "Aceptar" Then
            ...
            If txtnombre.Text <> "" Then
                Dim msg = objConexion.mantenimientoformapago(New String() {
    ...
    Private Sub btneliminar_Click(sender As Object, e As EventArgs) Handles btneliminar.Click
        If txtid.Text <> "" Then
            If (MessageBox.Show("Esta seguro de borrar a " + txtnombre.Text, mensajeenmentana,
                ...
                Dim msg = objConexion.mantenimientoformapago(New String() {txtid.Text}, "eliminar", comandosql, idTabla)
